...
@epic:E2E @feature:Login @owner:QATeam
Funcionalidade: Login na aplicação
  ...
  @severity:blocker @story:LoginValido @tag:smoke @tag:regressao
  ...
  @severity:critical @story:ValidacaoCampos @tag:regressao
  ...
  @severity:critical @story:UsuarioBloqueado @tag:regressao @tag:seguranca
  ...
  @severity:normal @story:NavegacaoPosLogin @tag:regressao
